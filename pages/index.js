      ...
      <main>
        ...
        <section className="w-full px-1 pb-12 antialiased bg-white">
            <div className="">
                ...
                <div className="container max-w-lg px-4 py-14 mx-auto text-left md:max-w-none md:text-center">
                    ...
                    <div className="mx-auto mt-5 text-gray-500 md:mt-12 md:max-w-lg md:text-center lg:text-lg">Si todavía no has digitalizado tu negocio, ¡es el momento! El Ministerio de Asuntos Económicos y Transformación Digital lanza el programa Kit Digital para Pymes y Autónomos.</div>
            ...
            <div className="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
                ...
                <div className="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
                    ...
                    <p className="pt-4 pb-4 m-0 leading-7 text-gray-700 border-0 border-gray-300 sm:pr-12 xl:pr-32 lg:text-lg">
                        El programa consiste en un bono digital con una cuantía económica, que se adjudica en función del tamaño de tu empresa, para ayudarte en el proceso de digitalizarla.
                        <br /><br />
                        Pueden recibir las ayudas las empresas o autónomos:
                    </p>
            ...
            <div className="box-border flex flex-col items-center content-center px-8 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
                ...
                <div className="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
                    <p className="pt-4 pb-8 m-0 leading-7 text-gray-700 border-0 border-gray-300 sm:pr-10 lg:text-lg">
                      ...
                      El Kit Digital se enmarca en el Plan de Recuperación, Transformación y Resiliencia, la agenda España Digital 2025 y el Plan de Digitalización de Pymes 2021-2025 y forma parte de los fondos Next Generation que la Unión Europea está repartiendo que están dotados, en el caso de España, de hasta 3.067 millones de euros.<br /><br />
        ...
        <section className="w-full bg-white pt-7 pb-7 md:pt-20 md:pb-24">
          <div className="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row md:items-start max-w-7xl lg:px-16">
            ...
            <div className="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
              <p className="pt-4 pb-8 m-0 leading-7 text-gray-700 border-0 border-gray-300 sm:pr-10 lg:text-lg">Estas empresas podrán recibir hasta un máximo de 12.000 en ayudas que tendrán que utilizar en la digitalización de sus negocios eligiendo las soluciones digitalizadoras del Kit Digital que mejor se adapten a las necesidades de sus negocios.</p>
            </div>

            <div className="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
              <p className="pt-4 pb-8 m-0 leading-7 text-gray-700 border-0 border-gray-300 sm:pr-10 lg:text-lg">Para poder acceder al Kit Digital deberán hacerlo a través de uno o varios agentes digitalizadores que podrán encontrar en la página Acelera pyme. Esto último es importante porque las empresas digitalizadoras son las que acompañarán en todo el proceso de solicitud a las empresas.</p>
            </div>
        ...
        <section id="requisitos" className="py-14 bg-white">
            <div className="px-8 mx-auto max-w-7xl lg:px-16">
                <h2 className="mb-4 text-xl font-bold md:text-3xl">Requisitos para conseguir el bono digital</h2>
        ...
        <section id="pasos" className="relative py-16 bg-white min-w-screen animation-fade animation-delay">
            <div className="container px-0 px-8 mx-auto sm:px-12 xl:px-5">
                ...
                <div className="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
                    <h3 className="text-lg font-bold text-yellow-500 sm:text-xl md:text-2xl">2. Consulta</h3>
                    <p className="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
                ...
                <div className="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
                    <h3 className="text-lg font-bold text-yellow-500 sm:text-xl md:text-2xl">3. Solicitud Bono</h3>
                    <p className="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
                        Accede y solicita de forma online tu bono digital en la <a href="http://sede.red.gob.es/" target="_blank" className='text-yellow-600 hover:text-yellow-500' rel="nofollow noopener noreferrer">sede electrónica de Red.es</a>. Completa todos los pasos del formulario.
                    </p>
                </div>
                <div className="w-full px-6 py-6 mx-auto mt-10 bg-white border border-gray-200 rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
                    <h3 className="text-lg font-bold text-yellow-500 sm:text-xl md:text-2xl">4. Proveedor</h3>
                    <p className="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
        ...
        <section id="soluciones" className="w-full bg-white py-7 md:py-12">
                <h3 className="mt-1 mb-8 text-2xl font-bold text-left text-gray-800 sm:mx-6 sm:text-3xl md:text-4xl lg:text-5xl sm:text-center sm:mx-0">
                    Soluciones
                </h3>
            <div className="box-border flex flex-col items-center content-center px-8 mx-auto leading-6 text-black border-0 border-gray-300 border-solid md:flex-row max-w-7xl lg:px-16">
            ...
            <div className="box-border flex flex-col items-center content-center px-8 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
                ...
                <h2 className="m-0 text-xl font-semibold leading-tight border-0 border-gray-300 lg:text-3xl md:text-2xl">
                    ...
                    <p className="pt-4 pb-8 m-0 leading-7 text-gray-700 border-0 border-gray-300 sm:pr-10 lg:text-lg">
                        El Agente digitalizador es una empresa o profesional que cumple los requisitos que se exigen desde la Administración, para ofrecer a tu empresa los servicios o parte de los servicios incluidos en el Kit Digital.
                    </p>
                </div>
        ...
        <section id="solucion-web" className="w-full bg-white py-7 md:py-12">
            ...
            <div className="box-border flex flex-col items-center content-center px-8 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
                ...
                <div className="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
                  ...
                  <ul>
                      <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                      <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-red-300 rounded-full"><span className="text-sm font-bold">x</span></span>Sesiones de fotografía</li>

                      <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                      <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-red-300 rounded-full"><span className="text-sm font-bold">x</span></span>Redacción o traducción de textos</li>
            ...
            <div className="box-border flex flex-col items-center content-center px-8 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
                ...
                <div className="box-border w-full text-black border-solid md:w-1/2 md:pl-6 xl:pl-32">
                  ...
                  <ul className="p-0 m-0 pt-4 leading-6 border-0 border-gray-300">
                    ...
                    <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                    <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span>Consultoría para la definición del sitemap y estructura de la tienda online.
                    </li>
                    ...
                    <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                    <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span>Diseño responsive.
                    </li>
                    ...
                    <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                    <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-yellow-300 rounded-full"><span className="text-sm font-bold">✓</span></span>Integración con Sendinblue y gestión de carritos abandonados.
                    </li>
                  ...
                  <ul>
                      <li className="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                      <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-red-300 rounded-full"><span className="text-sm font-bold relative">x</span></span>Sesiones de fotografía</li>
        ...
        <section id="contacto" className="px-2 py-32 bg-white md:px-0">
            <div className="container items-center max-w-6xl px-5 mx-auto space-y-6 text-center">
                <h1 className="text-4xl font-extrabold tracking-tight text-left text-gray-900 sm:text-5xl md:text-6xl md:text-center">
                    <span className="block">Empieza a tener <br /><span className="block mt-1 text-yellow-500 lg:inline lg:mt-0">Presencia Online</span></span>
                </h1>
